...
El desarrollo del clasificador se realizó empleando Bayes Naive Gaussiano, luego de leer los datos se llama a la función bayes\_naive\_gaussiano que recibe como entrada los siguientes parámetros:
\begin{itemize}
