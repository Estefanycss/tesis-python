...
# Read data file
df = pd.read_excel('../data/datagnel.xlsx', sheet_name='datag')
...
layout1 = go.Layout(barmode='overlay', title = "Pesos calibre 1 para cada densidad")
fig1 = go.Figure(data=data1, layout=layout1)
plotly.offline.plot(fig1,filename="pesos1.html")

data2 = [trace4, trace5, trace6]
layout2 = go.Layout(barmode='overlay', title = "Pesos calibre 2 para cada densidad")
fig2 = go.Figure(data=data2, layout=layout2)
plotly.offline.plot(fig2,filename="pesos2.html")

data3 = [trace7, trace8, trace9]
layout3 = go.Layout(barmode='overlay', title = "Pesos calibre 3 para cada densidad")
fig3 = go.Figure(data=data3, layout=layout3)
plotly.offline.plot(fig3,filename="pesos3.html")

data4 = [trace10, trace11, trace12]
layout4 = go.Layout(barmode='overlay', title = "Pesos calibre 4 para cada densidad")
